...
public final class ActivityUpdateServiceBinding implements ViewBinding {
  ...
  @NonNull
  public final EditText cityUpdate;

  @NonNull
  public final EditText countryUpdate;
  ...
  @NonNull
  public final EditText postalCodeUpdate;

  @NonNull
  public final EditText reasonCallUpdate;

  @NonNull
  public final EditText streetUpdate;
  ...
  private ActivityUpdateServiceBinding(@NonNull NestedScrollView rootView,
      @NonNull EditText cityUpdate, @NonNull EditText countryUpdate,
      @NonNull AppCompatButton deleteUpdate, @NonNull EditText deptUpdate,
      @NonNull EditText dispatchNoteUpdate, @NonNull EditText fechaUpdate,
      @NonNull EditText nameUpdate, @NonNull EditText postalCodeUpdate,
      @NonNull EditText reasonCallUpdate, @NonNull EditText streetUpdate,
      @NonNull EditText typeUpdate, @NonNull AppCompatButton update,
      @NonNull EditText userPhoneUpdate) {
    ...
    this.streetUpdate = streetUpdate;
  ...
  public static ActivityUpdateServiceBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      id = R.id.cityUpdate;
      EditText cityUpdate = ViewBindings.findChildViewById(rootView, id);
      if (cityUpdate == null) {
        break missingId;
      }

      id = R.id.countryUpdate;
      EditText countryUpdate = ViewBindings.findChildViewById(rootView, id);
      ...
      id = R.id.postalCodeUpdate;
      EditText postalCodeUpdate = ViewBindings.findChildViewById(rootView, id);
      ...
      id = R.id.streetUpdate;
      EditText streetUpdate = ViewBindings.findChildViewById(rootView, id);
      ...
      return new ActivityUpdateServiceBinding((NestedScrollView) rootView, cityUpdate,
          countryUpdate, deleteUpdate, deptUpdate, dispatchNoteUpdate, fechaUpdate, nameUpdate,
          postalCodeUpdate, reasonCallUpdate, streetUpdate, typeUpdate, update, userPhoneUpdate);
    }
