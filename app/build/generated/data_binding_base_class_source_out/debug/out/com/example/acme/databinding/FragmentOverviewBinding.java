...
public final class FragmentOverviewBinding implements ViewBinding {
  ...
  private FragmentOverviewBinding(@NonNull FrameLayout rootView, @NonNull TextView adress,
      ...
      @NonNull TextView dept, @NonNull TextView dept1, @NonNull TextView dispatchNote,
      @NonNull Guideline div1, @NonNull Guideline div2, @NonNull Guideline div3,
      @NonNull Guideline div4, @NonNull TextView fecha, @NonNull TextView headerText,
      @NonNull TextView listReason, @NonNull Button mapsG, @NonNull ImageView menuImage,
      @NonNull TextView menuText, @NonNull Guideline midToolbarGuideline, @NonNull TextView name,
      @NonNull TextView phone, @NonNull TextView reason, @NonNull TextView service,
      @NonNull TextView service1, @NonNull TextView textView2, @NonNull TextView ticket,
      @NonNull Guideline topToolbarGuideline) {
  ...
  public static FragmentOverviewBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      id = R.id.dept1;
      TextView dept1 = ViewBindings.findChildViewById(rootView, id);
      if (dept1 == null) {
        break missingId;
      }
      ...
      id = R.id.service1;
      TextView service1 = ViewBindings.findChildViewById(rootView, id);
      if (service1 == null) {
        break missingId;
      }
      ...
      return new FragmentOverviewBinding((FrameLayout) rootView, adress, backDashboard,
          bottomToolbarGuideline, calendarText, constraintLayout, dept, dept1, dispatchNote, div1,
          div2, div3, div4, fecha, headerText, listReason, mapsG, menuImage, menuText,
          midToolbarGuideline, name, phone, reason, service, service1, textView2, ticket,
          topToolbarGuideline);
    }
